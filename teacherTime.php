...
<nav class="navbar navbar-expand-sm navbar-light">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            <img src="http://localhost/Aravinth/dist/img/diulogoside.png" style="max-width:150px"/>
            <a href="homepage.php" class="navbar-brand" style="font-size:25px">589,Chendhuran Polytechnic College</a>
        </div>
    </div>
</nav>
<section>
